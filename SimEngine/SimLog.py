...
# === rpl
LOG_RPL_DIO_TX                    = {u'type': u'rpl.dio.tx',                u'keys': [u'_mote_id',u'packet',u'hops']}
...
# === mote info
LOG_RADIO_STATS                   = {u'type': u'radio.stats',               u'keys': [u'_mote_id', u'is_sync', u'idle_listen', u'tx_data_rx_ack', u'tx_data', u'rx_data_tx_ack', u'rx_data', u'sleep']}
...
# === user 
LOG_USER_MINIMALCELL_TX           = {u'type': u'user.minimalcell_tx',   u'keys': [u'channel',u'num_per_packet_type',u'is_interference']}
...
LOG_USER_MINIMAL_CELL_CONGESTION  = {u'type': u'user.minimal_cell_congestion',  u'keys': [u'_mote_id', u'minimal_cell_asn', u'num_minimal_cells_rx', u'num_minimal_cells_tx', u'minimal_cell_utilization', u'neighbor_num', u'neighbor_rssi_sum', u'network_nodes_num', u'minimal_cell_chan_seq']}
