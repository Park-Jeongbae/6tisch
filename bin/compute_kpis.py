...
def kpis_all(inputfile, subfolder):
 ...
 #=========================================================================================================================
    ...
    for (run_id, per_mote_stats) in allstats.items():
        ...
        file_name = "{}\mote_{}_{}_{}_({},{},{},{},{},{}).xlsx".format(folder_path, run_id, file_settings['exec_numMotes'], current_time,file_settings['user_minimlNumChans'],1,d.MSF_MAX_MINIMAL_NUMCELLS,d.INIT_LEARNING_RATE,d.INIT_DISCOUNT_FACTOR,d.INIT_EXPLORATION_RATE)
